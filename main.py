...
exercises = [
    ...
    "• Заменить материал: вместо керамики использовать экологичные материалы, такие как бамбук или переработанный пластик.\n"
    "• Заменить форму: вместо традиционной круглой формы сделать чашку квадратной или многогранной.\n"
    "• Заменить ручку: использовать силиконовую накладку вместо керамической ручки для лучшей теплоизоляции.\n\n"
    "C - Combine (Комбинировать)\n"
    "• Объединить чашку с блюдцем в единую конструкцию.\n"
    "• Встроить в чашку термометр для отображения температуры напитка.\n"
    "• Добавить съемное ситечко для заваривания чая.\n\n"
    "A - Adapt (Адаптировать)\n"
    "• Адаптировать дизайн для использования в автомобиле (с устойчивым основанием).\n"
    "• Создать версию с двойными стенками для лучшего сохранения температуры.\n"
    "• Разработать складную версию для путешественников.\n\n"
    "M - Modify (Модифицировать)\n"
    "• Изменить размер: создать мини-версию для эспрессо или большую версию для любителей больших порций.\n"
    "• Добавить крышку для предотвращения проливания и сохранения тепла.\n"
    "• Модифицировать поверхность, добавив текстуру или рельеф для лучшего удержания.\n\n"
    "P - Put to another use (Применить в другом качестве)\n"
    "• Использовать как органайзер для канцелярских принадлежностей.\n"
    "• Превратить в кашпо для маленьких растений.\n"
    "• Применять как подставку для свечей.\n\n"
    "E - Eliminate (Устранить)\n"
    "• Убрать ручку, создав более минималистичный дизайн.\n"
    "• Отказаться от глазури, оставив натуральную текстуру керамики.\n"
    "• Устранить плоское дно, создав чашку-неваляшку.\n\n"
    "R - Reverse/Rearrange (Обратить/Переставить)\n"
    "• Перевернуть дизайн, сделав чашку в форме перевернутого конуса.\n"
    "• Расположить ручку сверху, а не сбоку.\n"
    "• Создать чашку с двумя отверстиями: одно для питья, другое для аромата.",
